...
export default function ConversationsPage() {
  ...
  return (
    <div className="flex gap-0 h-[calc(100vh-8rem)] -m-8 overflow-hidden rounded-xl border border-dark-200 bg-white">
      {/* Panel izquierdo — lista de conversaciones */}
      <div className="w-80 flex flex-col border-r border-dark-200 flex-shrink-0">
        {/* Header del panel */}
        <div className="px-4 py-4 border-b border-dark-200">
          ...
          {/* Filtro — Esperando agente (destacado) */}
          <button
              ...
              {agentPendingCount > 0 ? (
                <>
                  ...
                  <p className="text-dark-400 text-sm mt-1">
                    Haz clic en una conversación para atenderla
                  </p>
                </>
              ) : (
                <>
          ...
          <>
            ...
            <div className="px-6 py-4 border-b border-dark-200 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-dark-200 flex items-center justify-center text-lg">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-dark-400">
                      {channelEmoji[detail.channel.type]} {detail.channel.type}
                    </span>
                  </div>
                </div>
              </div>

              {/* Controles de bot / agente */}
              <div className="flex items-center gap-2">
                {detail.status === 'BOT_ACTIVE' ? (
                  ...
                  <>
                    <span className="text-sm text-green-600 font-medium">
                      👤 {detail.assignedAgent?.name || 'Agente activo'}
                    </span>
            ...
            {detail.status === 'AGENT_ACTIVE' && (
              <div className="px-6 py-4 border-t border-dark-200">
                ...
                <p className="text-xs text-dark-400 mt-1.5">
                  Estás respondiendo como agente humano. Enter para enviar.
                </p>
              </div>
            )}

            {detail.status === 'BOT_ACTIVE' && (
              <div className="px-6 py-3 border-t border-dark-200 bg-dark-50">
