...
- **Primeros pasos (checklist de onboarding):** tarjeta en el Dashboard del cliente con 3 pasos (cambiar contraseña, completar info del negocio, conectar un canal) — se oculta sola cuando los 3 están completos
